...
<html lang="en">
    ...
    <body>
        <h1 class="text-center">Create a form page for events</h1>
        ...
        <div class= "jumbotron col-md-4 mx-auto border border-dark rounded-lg m-4 p-4" style="background-color:lightgray">
            ...
            <form name="eventsForm" id="eventsForm" method="post" action="eventForm.php">
                ...
                <div class="text-center">
                    <input type="submit" class="bg-primary text-light rounded-sm" name="submit" id="submit" value="Add Event">
